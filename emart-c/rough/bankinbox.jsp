...
<br><br><br><br>
<fieldset>
<legend align=center><font color=blue face=tahoma>Bank Inbox </legend><BR>
...
<%  String buff="";
	...
	int count=0;
	boolean rec=false;
	head+="<table align=center width=600 cellspacing=1 cellpadding=2 bgcolor=lightslategray><form method=post action=\"bank_deletemsgchecked.jsp\">";
