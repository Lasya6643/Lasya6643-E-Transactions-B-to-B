...
if((company.length==0) || (productid.length==0) || (name.length==0) || (details.length==0) || (image.length==0)|| (typeid.length==1))
{
...
<body >
<form name=products action=productsd3.jsp>
...
<TR>
<TD CLASS="glformhead" HEIGHT="24" VALIGN="MIDDLE" align=center><B>Products Deletion Details</B></TD></TR>
</table>
<%
...
<tr><td class=td><b>Products Type</b></td><td>
<input name=typeid type=text size=60 value=<%=rs.getString(6)%>></td></tr>
<%}%>
</table>
<center>
