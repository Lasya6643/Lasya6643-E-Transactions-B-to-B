...
<TR>
<TD CLASS="glformhead" HEIGHT="24" VALIGN="MIDDLE" align=center><b> List of Rejected Tenders </b> </TD></TR>
</table>

<%  String buff="";
    String head="";
	try {
	String cmd="Select BIDNO,TID,a.Company,DOS from directory a ,tenderbids where status = 'e' and a.company = tenderbids.cid";
