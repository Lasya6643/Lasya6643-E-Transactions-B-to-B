...
<TR>
<TD CLASS="glformhead" HEIGHT="24" VALIGN="MIDDLE" align=center><b> Accepted Tenders </b> </TD></TR>
</table>
<%  String buff="";
    String head="";
	try {
	String cmd="Select BIDNO,c.TID,a.company,DOS,company,tenderwork from directory a ,tenderbids b ,tenderslist c where b.status = 'l' and a.company = b.cid and  b.tid=c.tid";
	...
	head+="<tr bgcolor=lightslategray><th style='color:aliceblue'>Bid Num</th><th style='color:aliceblue'>Contract Id</th><th style='color:aliceblue'>Contract Name</th><th style='color:aliceblue'>Tender Id</th><th style='color:aliceblue'>Work Name </th><th style='color:aliceblue'>Date</th></tr>";
	while(rs.next()) {
        rec=true;
		count++;
		int id=rs.getInt(1);
