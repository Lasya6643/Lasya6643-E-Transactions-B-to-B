...
<form name=products method=post  action=industryd2.jsp>
...
<TR>
<TD CLASS="glformhead" HEIGHT="24" VALIGN="MIDDLE" align=center><B>Industry Deletion</B></TD></TR>
</table><TABLE WIDTH="90%" BORDER="1" CELLPADDING="8" CELLSPACING="0"  BORDERCOLOR="#DDF0FF" STYLE="border-collapse:collapse;" ALIGN="CENTER">
<tr> 
<td width="44%"> 
<div align='right'>Type of Industry</div>
</td>
<td width="56%"> 
<select name="type">
<%while(rs.next()){%>
