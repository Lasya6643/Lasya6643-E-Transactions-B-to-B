...
<form name=products method=post  action=ptypem2.jsp>
...
<TR>
<TD CLASS="glformhead" HEIGHT="24" VALIGN="MIDDLE" align=center><B>Product Types Modification</B></TD></TR>
</table><TABLE WIDTH="90%" BORDER="1" CELLPADDING="8" CELLSPACING="0"  BORDERCOLOR="#DDF0FF" STYLE="border-collapse:collapse;" ALIGN="CENTER">
<tr> 
<td width="44%"> 
<div align='right'>Product Type Id</div>
</td>
<td width="56%"> 
<select name="typeid">
<%while(rs.next()){%>
