...
<TR>
<TD CLASS="glformhead" HEIGHT="24" VALIGN="MIDDLE" align=center><B>List of Alloted Tenders</B></TD></TR>
</table>
...
<%  String buff="";
	...
	String cmd="Select BIDNO,TID,a.company,DOS,company  ,status from directory a ,tenderbids b where  status = 'l' and a.company = b.cid and  b.cid ='" + u + "'";
