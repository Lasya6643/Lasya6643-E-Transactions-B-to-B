...
sst1.setString(1,company);
sst1.setString(2,company);
sst1.setString(3,"c");
...
<legend align=center><font face=tahoma>Entry Report</legend><BR>
  <br>  <br>  <br>  <br>
  <center>
  <h3>Your  Entry Succeeded<br>
	Your Login/Password Is Ur Comapny Name<br>
	You Could be able to Change it After SignUp</h3>
	<a href=general.html><img src=images\p5.gif></a>
  <br><br></center>
<%}
else
{%>
