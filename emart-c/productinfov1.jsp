...
ResultSet rs=st.executeQuery("select * from products where typeid ='"+typeid+"'");
%>
<body id=body> 
...
<TR>
<TD CLASS="glformhead" HEIGHT="24" VALIGN="MIDDLE" align=center><B>Catalogues Detailed Report</B></TD></TR>
