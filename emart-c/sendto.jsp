...
try {
    ...
    out.println("<link rel=stylesheet href='air.cdf'><body bgColor= #bbe9ff><br><br><br><br><h3 align=center>Your Email Sent Succesfully</h1><br><br><center><a href=\"javascript:history.back()\">Continue</a>&nbsp;&nbsp;<a href=\"index.htm\" target=\"_parent\"></a>");
	}catch(Exception e)	{
	String msgs=" ";
